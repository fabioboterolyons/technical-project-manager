...
evaluation_criteria = "User stories should be written in the format 'As a [type of user], I want [an action or feature] so that [benefit/value].'"
persona_program_manager_eval = "You are a Program Manager, you are responsible for evaluating the user stories generated by the Product Manager and ensuring they meet the expected structure and criteria."
product_manager_evaluation_agent = EvaluationAgent(open_ai_key, persona_program_manager_eval, evaluation_criteria, product_manager_knowledge_agent, 5)
...
routes = [
    {'name': 'Product Manager', 'description': 'Assists with product-related tasks', 'func': lambda user_prompt: product_manager_evaluation_agent.evaluate(user_prompt)},
    {'name': 'Program Manager', 'description': 'Handles program-level tasks', 'func': lambda user_prompt: program_manager_evaluation_agent.evaluate(user_prompt)},
    {'name': 'Development Engineer', 'description': 'Supports development tasks', 'func': lambda user_prompt: development_engineer_evaluation_agent.evaluate(user_prompt)}
]
